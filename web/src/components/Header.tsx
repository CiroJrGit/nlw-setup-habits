    ...
    <div className="w-full max-w-3xl mx-auto flex justify-between items-center">
      ...
      <Dialog.Root>
        <Dialog.Trigger
          ...
          type="button"
        >
          <Plus size={20} className="text-violet-500 group-hover:text-violet-200" />
          Novo hábito
        </Dialog.Trigger>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <Dialog.Close className="absolute right-6 top-6 text-zinc-400 rounded-md hover:text-zinc-200 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900">
